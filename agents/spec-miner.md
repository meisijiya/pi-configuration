---
name: spec-miner
description: 从既有代码库提取 OpenSpec spec,输出 openspec/specs/<capability>/spec.md。Write 仅限 openspec/specs/,bash 仅读。
tools: read, grep, find, bash, ls, write
...
| Has at least one `#### Scenario:` | Has no Scenarios; MAY have a `<!-- verified_by: -->` |
