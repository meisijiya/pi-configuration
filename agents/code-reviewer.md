---
name: code-reviewer
description: 通用代码评审专家,13K prompt 检查清单,Confidence-based 过滤 + CRITICAL/HIGH/MEDIUM/LOW 严重度分级,Pre-Report Gate 防误报。在改动完成、准备合并/提交前调用。
tools: read, grep, find, bash, ls
model: opencode-go/deepseek-v4-flash
thinking: medium
prompt_mode: replace
extensions: true
exclude_extensions: rtk
skills: false
color: red
max_turns: 30
---
...
- **Large bundle sizes** — Importing entire libraries when tree-shakeable alternatives
